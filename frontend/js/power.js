// Power state manager
const PowerState = {
    isOff: localStorage.getItem('powerState') === 'true', // Load saved state, default to true if not set
    ...
    updateUI: function() {
        ...
        if (this.isOff) {
            ...
            animatedRing?.classList.add('hidden');
        } else {
            ...
            animatedRing?.classList.remove('hidden');
        }
    },
